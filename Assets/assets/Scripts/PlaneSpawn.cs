...
//    public GameObject smallCubePrefab;       // The prefab for the small cubes
...
//        newBuilding.transform.position = new Vector3(position.x, buildingHeight / 2f, position.z);
...
//        Vector3 startPrefabPosition = new Vector3(startX, planeYOffset, 0f);
...
//        float endX = startX + (numberOfPlanes - 1) * planeSpacing;
...
//                Instantiate(smallCubePrefab, cubePosition, Quaternion.identity);
//            }
